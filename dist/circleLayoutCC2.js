...
export function circleLinearPlacement(graph /*, ntone: number*/) {
...
function evenCircleBetweenThrackles(graph, orderedVertices, ntone, colors, x0 = 0, y0 = 0, xDist = 100, yDist = 200) {
    const ordered = [];
...
function addRemainingVerticesEvenCircle(graph, orderedVertices, ntone, xDist = 100) {
...
function evenCircleLinearThrackle(graph, orderedVertices, colors, x0 = 0, y0 = 0, xDist = 100, yDist = 200) {
    const ordered = [];
    const len = orderedVertices.length;
    // even vertices
...
// len > 3
function oddCircleLinearThrackle(graph, orderedVertices, x0 = 0, y0 = 0, xDist = 100, yDist = 200) {
    graph.removeBends();
    const ordered = [];
    const len = orderedVertices.length;
    // odd vertices
...
function addBends(graph, orderedVertices, colors, xDist = 100, yDist = 200) {
    graph.removeBends();
    const len = orderedVertices.length;
    // define vertices
    ...
    const edgeNN = graph.getEdgeByVertices(v_n_1, v_n);
    // edge12 bends
...
function placeMainVertices(graph, orderedVertices, limits, x0 = 0, y0 = 0, xDist = 100, yDist = 200) {
    const len = graph.vertices.length;
...
function placeMainVerticess(graph, orderedVertices, limits, x0 = 0, y0 = 0, xDist = 100, yDist = 200) {
    const len = graph.vertices.length;
...
function linearPlacement(graph, orderedVertices, x0 = 0, y0 = 0, xDist = 100, yDist = 200) {
    const len = orderedVertices.length;
...
export function pathLinearPlacement(graph) {
