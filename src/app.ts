...
let cliqueNewEdgesColor: string = '#0000ff'
// palette settings
...
//window.addEventListener("DOMContentLoaded", () => {
    ...
    const settingsCliqueNewEdgesColorInput = document.getElementById('clique-new-edges-color') as HTMLInputElement;
...
if (settingsCloseButton) { settingsCloseButton.addEventListener('click', hideAllModals/*hideSettingsModal*/); }
