...
let customAlertMessage: HTMLSpanElement | null = null;
let customAlertCloseBtn: HTMLButtonElement | null = null;
 ...
 */
function initializeCustomAlert(): void {
    customAlert = document.getElementById('customAlert') as HTMLElement;
    customAlertMessage = document.getElementById('customAlertMessage') as HTMLSpanElement;
    customAlertCloseBtn = document.getElementById('customAlertCloseBtn') as HTMLButtonElement;
 ...
 */
export function showCustomAlert(message: string, type: 'warning' | 'error' | 'success' = 'warning', duration: number = 3000): void {
    if (!customAlert || !customAlertMessage) {
