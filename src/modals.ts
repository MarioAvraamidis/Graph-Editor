...
export class ModalsHandler
{
    ...
    private activateLayoutModal(graph: Graph, stateHandler: StateHandler, myCanvasHandler: CanvasHandler, selector: Selector)
    {
    ...
    private enableSelectableTooltips() {
        const tooltip = document.createElement("div");
        tooltip.className = "info-tooltip";
        document.body.appendChild(tooltip);

        const icons = document.querySelectorAll<HTMLElement>(".info-icon");
