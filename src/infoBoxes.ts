...
export class InfoBoxHandler
{
    ...
    private showVertexInfo(canvas: HTMLCanvasElement, vertex: Vertex) {
    ...
    private hideVertexInfo() {
        const infoBox = document.getElementById("vertex-info")!;
        infoBox.style.display = "none";
    }

    // show a box with information about the hovered crossing
    private showCrossingInfo(canvas: HTMLCanvasElement, cross: Crossing) {
        // const canvas = document.getElementById("graphCanvas") as HTMLCanvasElement;
    ...
    private hideCrossingInfo() {
        const infoBox = document.getElementById("crossing-info")!;
        infoBox.style.display = "none";
    }

    private showEdgeInfo(canvas: HTMLCanvasElement, edge: Edge) {
