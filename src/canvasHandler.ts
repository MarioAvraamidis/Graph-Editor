...
export class CanvasHandler {
    ...
    constructor(canvasId: string, drawCallback: DrawGraphCallback) {
    ...
    public fixView(graph: Graph, selector: Selector)
    {
    ...
    private fixViewRect(top: number, bottom: number, left: number, right: number, paddingFactor: number = 0.8): void {
    ...
    private addEventListeners(): void {
        ...
        document.getElementById('zoomInButton')?.addEventListener('click', () => this.zoom(this.ZOOM_FACTOR));
        document.getElementById('zoomOutButton')?.addEventListener('click', () => this.zoom(1 / this.ZOOM_FACTOR));
